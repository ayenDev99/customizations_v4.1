...
<table border="1" cellpadding="2">
    <tr class="tr-head">
        <th align="center" style="text-transform: uppercase; background-color: #AAA;" colspan="17"><strong>'. strtoupper('Persons with Disability Sales Book/Report') .'</strong></th>
    </tr>
    <tr class="tr-head">
        ...
        <th style="font-weight: bold;" align="center" rowspan="2">PWD No.</th>
        ...
        <th style="font-weight: bold;" align="center" rowspan="2">PWD Discounts</th>
