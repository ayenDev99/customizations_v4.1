...
<table border="1" cellpadding="2">
    <tr class="tr-head">
        <th align="center" style="text-transform: uppercase; background-color: #AAA;" colspan="17"><strong>'. strtoupper('National Athletes and Coaches Sales Book/Report') .'</strong></th>
    </tr>
    <tr class="tr-head">
        ...
        <th style="font-weight: bold;" align="center" rowspan="2">NAAC No.</th>
        ...
        <th style="font-weight: bold;" align="center" rowspan="2">NAAC Discounts</th>
        <th style="font-weight: bold;" align="center" rowspan="2">Other Discounts</th>
    ...
    foreach ($result as $key => $res) {
        $html .=
            '<tr>
                ...
                <td align="center">' . $res['CUST_NO'] . '</td>
